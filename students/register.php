...
if (isset($_POST['submit'])) {
    ...
    if ($count > 0) {
        ...
        $query1 = "insert into  registration(regNo,firstName,middleName,lastName,gender,contactNo,emailid,password) values(?,?,?,?,?,?,?,?)";
    ...
    <div class="login-page bk-img" style="background-image: url(../images/login10.jpg);height: 145%;">
        <div class="context-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-title text-white" style="margin-top:5%" >Student Registration </h2>
                        <div class="row">
                            <div class="col-md-12">
