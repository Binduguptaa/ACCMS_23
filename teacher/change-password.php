...
if (isset($_POST['changepwd'])) {
	...
	$sql = "SELECT password FROM teachers where password=?";
	...
	if ($row_cnt > 0) {
		$con = "update teachers set password=?,passUdateDate=?  where id=?";
							...
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">
										<?php $result = "SELECT passUdateDate FROM teachers WHERE id=?";
