...
if (isset($_POST['submit'])) {
	...
	if ($count > 0) {
		...
		$query = "INSERT INTO teachers (regno, firstName, middleName, lastName, gender, contactno, egycontactno, experties, emailid, password, corresAddress, corresCity, corresState, corresPincode, pmntAddress, pmntCity, pmnatetState, pmntPincode) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
		$stmt = $mysqli->prepare($query);

		// Assuming the variable values are defined elsewhere in your code
		$stmt->bind_param('issssiissssssisssi', $regno, $fname, $mname, $lname, $gender, $contactno, $emcntno, $role, $emailid, $password, $caddress, $ccity, $cstate, $cpincode, $paddress, $pcity, $pstate, $ppincode);
		$stmt->execute();
		$stmt->close();
	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title">Teacher's Registration </h2>
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-primary">
									...
									<div class="panel-body">
										<form method="post" action="" class="form-horizontal">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Specialization/Expertise: </label>
												<div class="col-sm-8">
