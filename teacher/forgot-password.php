...
if (isset($_POST['login'])) {
	...
	$stmt = $mysqli->prepare("SELECT emailid,contactNo,password FROM course_cordinator WHERE (emailid=? && contactNo=?) ");
...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(../images/login10.jpg);">
