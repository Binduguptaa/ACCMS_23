...
if (isset($_POST['update'])) {
	...
	$query = "update teachers set firstName=?,middleName=?,lastName=?,gender=?,contactNo=?,updationDate=? where id=?";
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				?>
					<div class="row">
						<div class="col-md-12">
							<h2 class="page-title" style="margin-top:7%"><?php echo $row->firstName; ?>'s&nbsp;Profile </h2>
