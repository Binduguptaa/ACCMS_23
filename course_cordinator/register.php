...
if (isset($_POST['submit'])) {
    ...
    if ($count > 0) {
        ...
        $query1 = "insert into  course_cordinator(regNo,firstName,middleName,lastName,gender,contactNo,email,password) values(?,?,?,?,?,?,?,?)";
...
<body>
    ...
    <div class="login-page bk-img" style="background-image: url(../images/login10.jpg);height: 145%;">
        <div class="context-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-title text-white" style="margin-top:5%">Course  Coordinator Registration </h2>
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="panel-body">
                                        <form method="post" action="" name="registration" class="form-horizontal" onSubmit="return valid();">
                                            ...
                                            <div class="col-sm-6 col-sm-offset-4">
                                                <a class="btn btn-default" type="reset" href="../sign_up.php">chancel</a>
