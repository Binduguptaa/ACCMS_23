...
if (isset($_POST['update'])) {
	...
	$query = "update course_cordinator set firstName=?,middleName=?,lastName=?,gender=?,contactNo=?,updationDate=? where id=?";
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				?>
					<div class="row">
						<div class="col-md-12">
							<h2 class="page-title" style="margin-top:5%;"><?php echo $row->firstName; ?>'s&nbsp;Profile </h2>
										...
										<div class="panel-body">
											<form method="post" action="" name="registration" class="form-horizontal" onSubmit="return valid();">
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="email" name="email" id="emaild" class="form-control" value="<?php echo $row->emailid; ?>" readonly>
