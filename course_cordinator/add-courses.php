...
if (isset($_POST['submit'])) {
	...
	$query = "insert into  course (course_code,course_fn,stream,course_cat,duration,course_amt) values(?,?,?,?,?,?)";
	$stmt = $mysqli->prepare($query);
	$rc = $stmt->bind_param('ssssss', $coursecode, $coursefn, $courseStrem, $coursecat, $coursedue, $courseamt);
	$stmt->execute();
									...
									<div class="panel-body">
										<form method="post" class="form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" name="cnf" value="" placeholder="course-fulname">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" value="" name="ca" class="form-control">
												</div>
											</div>
