...
if (isset($_POST['changepwd'])) {
	...
	$sql = "SELECT password FROM course_cordinator where password=?";
	...
	if ($row_cnt > 0) {
		$con = "update course_cordinator set password=?,passUdateDate=?  where id=?";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title" style="margin-top:7%">Change Password </h2>
							...
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">
										<?php $result = "SELECT passUdateDate FROM course_cordinator WHERE id=?";
