...
if (isset($_POST['submit'])) {
	...
	$query = "update registration set regno=?,firstName=?,middleName=?,lastName=?,gender=?,contactno=?,egycontactno=?,guardianName=?,guardianRelation=?,guardianContactno=?,emailid=?,password=?,corresAddress=?,corresCIty=?,corresState=?,corresPincode=?,pmntAddress=?,pmntCity=?,pmnatetState=?,pmntPincode=? where id=?";
	$stmt = $mysqli->prepare($query);

	$rc = $stmt->bind_param('issssiississsssisssii', $regno, $fname, $mname, $lname, $gender, $contactno, $emcntno, $gurname, $gurrelation, $gurcntno, $emailid, $password, $caddress, $ccity, $cstate, $cpincode, $paddress, $pcity, $pstate, $ppincode, $id);
	$stmt->execute();
										...
										<form method="post" class="form-horizontal">
											...
											?>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" value="<?php echo $row->guardianName; ?>" name="gname" id="gname" class="form-control" required="required">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" value="<?php echo $row->guardianRelation; ?>" name="grelation" id="grelation" class="form-control" required="required">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" value="<?php echo $row->guardianContactno; ?>" name="gcontact" id="gcontact" class="form-control" required="required">
													</div>
												</div>
